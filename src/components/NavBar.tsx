        ...
        {navItems.map((item) => (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <p className="font-dm-sans text-neutral-800 text-md">
                {item.label}
              </p>
            </div>
            {item.badgeCount !== undefined && (
              <p className="rounded-full bg-terracotta-600 text-neutral-400 text-xs w-6 h-6  flex items-center justify-center">
                {item.badgeCount}
              </p>
            )}
          </NavLink>
